    ...
    <div className='mt-32 px-4 py-7 lg:px-14 lg:py-16 relative z-20' style={bGround}>
        <div className=' text-white lg:flex lg:justify-between'>
          <div className='flex flex-col justify-center'>
            <div className='font-semibold text-lg lg:text-[33px] text-left mb-4 lg:mb-2'>Subscribe to Our News Letter</div>
            <p className='lg:text-base'>Be the first to know about releases and indusrty news and insights.</p>
          </div>
        <div>
        ...
        <div className='design-spot-mobile top-9 left-24 lg:w-36 lg:h-36 lg:top-0 lg:left-36 lg:bg-[#9354ED] z-10'></div>
    </div>
  )
};
