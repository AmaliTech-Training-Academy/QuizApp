...
export const QuizFilters = ({topics }) => {

  return (
    <div className='lg:border lg:border-l-0 lg:border-t-0 lg:border-b-0 lg:border-r-[#808080] ml-4 mr-11 lg:w-48 pr-7'>
      <div className='text-2xl font-semibold hidden lg:block'>Filters</div>
      <hr className='border border-[#999999] mt-7 hidden lg:block'/>
      <SubjectFilters topics={topics}/>
