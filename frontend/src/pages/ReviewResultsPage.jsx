        ...
        <div className='flex flex-col items-center justify-center'>
            ...
            {answers.results && answers.results.map((result, index) => (
                <div key={index}>
                    ...
                    <p className='my-5 py-5 px-3 rounded-lg ' style={result.correctAnswer === result.chosenAnswer ? {color: 'green', borderColor: '#3f3', borderWidth: '2px', background: '#cfc'} : {color: 'red', borderColor: 'red', borderWidth: '2px', background: '#FFE6E6'}}>Answer:{result.chosenAnswer}</p>
                </div>
                ))}
            </div>
            <div className='my-5'>
