  ...
  return (
    <div className=' mt-18'>
        <div className='relative'>
            ...
            <div className='flex flex-col gap-8 items-center md:w-[860px] md:h-[363px] absolute top-16 md:top-[225px] md:left-[28%] text-center'>
                <h1 className='text-white font-semibold text-3xl md:w-[458px] md:text-5xl'>Enjoy a User-Friendly Interface and Interactive Quiz Experience!</h1>
