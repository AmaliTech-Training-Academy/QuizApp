...
const Insight = () => {
  return (
    <div className='md:flex justify-between px-[67px] bg-[#F2F2F2] font-Roboto'>
      <div className='flex flex-col  gap-8 py-[166px] md:text-left md:left-40 md:top-32'>
